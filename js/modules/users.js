    ...
    body.innerHTML = `
      <div class="card">
        ...
        <div class="helper" style="margin-bottom:10px">
          Tạo tài khoản mới qua Supabase Dashboard &gt; Authentication &gt; Add user (bật "Auto Confirm").
          Dùng dạng username, không cần email thật: <code>thukho.iec@vttb.local</code>, <code>ketoan1@vttb.local</code>...
          Tài khoản mới mặc định quyền "Chỉ xem", vào đây nâng quyền sau khi xác định đúng người.
        </div>
        ${
